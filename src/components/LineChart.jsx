  ...
  return (
    <Paper
      ...
      sx={{
        padding: "20px",
        borderRadius: "10px",
        backgroundColor: `${colors.primary[400]} !important`, // Ensure it applies
        display: "flex",
        flexDirection: "row",
        alignItems: "center",
    ...
    >
      ...
      >
        ...
        {/* Vehicle Toggles */}
        <FormGroup sx={{ mb: 2, gap: "10px", mt: 3 }}>
      ...
      >
        {visibleData.length > 0 ? (
          <ResponsiveBar
          data={visibleData}
          keys={Object.keys(visibleVehicles).filter((key) => visibleVehicles[key])}
          indexBy="date"
          groupMode="grouped" // Ensures bars are side by side
          ...
          theme={{
            axis: {
              domain: {
                line: {
                  stroke: colors.grey[100], // Axis line color
                },
              },
              legend: {
                text: {
                  fill: colors.grey[100], // Legend text color
                },
              },
              ticks: {
                line: {
                  stroke: colors.grey[100], // Tick line color
                },
                text: {
                  fill: colors.grey[100], // Tick text color
                },
              },
            },
            grid: {
              line: {
                stroke: colors.grey[300], // Grid lines color
                strokeWidth: 1,
              },
            },
            tooltip: {
          ...
          axisLeft={{
            ...
            tickRotation: 0,
            legend:
              viewMode === "fuel_amount" ? "Fuel Amount (L)" : "Fuel Cost (MAD)",
            legendOffset: -40,
            legendPosition: "middle",
          }}
          legends={[]}
          ...
          style={{
            backgroundColor: colors.primary[400], // Explicitly set chart background
          }}
        />
